...
app.layout = html.Div(children=[
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            html.H2('ASIMOV', style={"font-family": "Voltaire", "font-size": "35px"}),
                            html.Hr(),
                            html.H6("Cidades"),
                            dcc.Checklist(
                            ...
                            html.H6("Variável de análise: ", style={"margin-top": "30px"}),
                            dcc.RadioItems(options=[{'label': i, 'value': i} for i in ["gross income", "Rating"]],value="gross income",id="main_variable",inline=True,)
